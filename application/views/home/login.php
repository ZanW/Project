...
<div class="container">
    <div class="col-md-4">
        <section class="login_member">
            ...
            <form method="post" action="<?php echo site_url('Login_con/validateMemberLogin') ?>" role="login">
                ...
                <div>
                    <div class="form-links">
                        <a
                            href="<?php echo site_url('Login_con/register');?>">Become a Member</a>
                        </a> or <a href="<?php echo site_url('members/forgetPassword') ?>">Reset
                            Password</a>
                    </div>
                </div>
            </form>
