...
<form method="post" action="<?php echo site_url('group/add')?>"
	...
	<div class="form-group">
		<label for="mid">Owner ID</label> <input type="text" name="id"
			value="<?php echo htmlspecialchars($_SESSION['ID']); ?>" readonly><br>
		<label for="mid">Owner Name</label> <input type="text" name="name"
