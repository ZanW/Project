    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="myNavbar">
            <ul class="nav navbar-nav">
                ...
                <li><a href="<?php echo site_url("List_mem_con/index"); ?>">Members</a></li>
                <li>
            ...
            <ul class="nav navbar-nav navbar-right">
                <li><a href=<?php echo site_url("membership/pay_now"); ?>><span
                            class="glyphicon glyphicon-random"></span>Pay Now</a></li>
                <li><a href="<?php echo site_url('home/login') ?>"><span class="glyphicon glyphicon-log-out"></span>
                        Logout</a></li>
            </ul>
        </div>
    </div>
  ...
  transition: all 0.3s cubic-bezier(.25,.8,.25,1);height: 400px;">
            <?php if (isset($_SESSION['privilege']) && $_SESSION['privilege'] == 1) { ?>
                <a href="<?php echo base_url("index.php/home/admin"); ?>"
                   style="margin-left: 20px">Administrator</a></br>
            <?php } ?>
